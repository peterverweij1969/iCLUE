...
public class AllocationHelper extends IterationHelper{
    ...
    public AllocationHelper(Landuses landuses, List<SpatialDataset> drivers, SuitabilityCalculator suitabilityCalculator, List<Conversion> conversions) {
    ...
    public RasterDataStack createAllocationMapsWithStochasticShock(Map<Clazz, DeviationStatus> landusesRequiringStochasticShock) {
            ...
            Map<Landuses.Landuse, RasterData> probabilityMaps = super.createProbabilityMaps(landusesRequiringStochasticShock);
    ...
    public Landuse getLanduseByProbabilties(CellStack allocationCellValues) {
        ...
        CellStack probabilityCellValues = removeLanduseCellValue(allocationCellValues, CellValueRemoval.LANDUSE_AND_AGE);
