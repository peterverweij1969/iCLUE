...
import nl.wur.iclue.model.TheModel;
import nl.wur.iclue.model.TheModel.Projections;
...
public class LanduseProjector {
    ...
    public static void main(String[] args) {
        ...
        // run the model
        TheModel model = new TheModel(params);
...
//        }
    ...
    private static void configureLogin() {
        Log.putTarget(SuitabilityCalculator.LOG_TOKEN, new FileLog(logSuitabilityFile));
        Log.putTarget(Probabilities.LOG_TOKEN, new FileLog(logProbabilitiesFile));
        Log.putTarget(TheModel.LOG_TOKEN, new FileLog(logIterationsFile));
    }
